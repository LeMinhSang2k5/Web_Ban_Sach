-- Active: 1750489318226@@127.0.0.1@3306
-- phpMyAdmin SQL Dump
-- version 5.2.1
-- https://www.phpmyadmin.net/
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th6 22, 2025 lúc 03:15 PM
...
VALUES (
        ...
        'Bán chạy',
        85000.00,
        './assets/img/sach-help-self/dacnhantam-review.png',
        448,
        100000.00,
        '-15%',
        'AZ Việt Nam',
    ...
    (
        ...
        'Bán chạy',
        99000.00,
        './assets/img/sach-van-hoc/bupsenxanh.png',
        448,
        100000.00,
        '-15%',
    ...
    (
        ...
        'Bán chạy',
        110000.00,
        './assets/img/sach-van-hoc/nhagiakim.png',
        448,
        100000.00,
        '-15%',
        'Nhã Lam',
    ...
    (
        ...
        NULL,
        110000.00,
        './assets/img/sach-van-hoc/bongsenvang.png',
        448,
        100000.00,
        '-15%',
        'Alpha Books',
    ...
    (
        ...
        'Bán chạy',
        85000.00,
        './assets/img/sach-van-hoc/maimailabaoxa.png',
        455,
        100000.00,
        '-15%',
        'Đinh Tị',
    ...
    (
        6,
        'Đột Phá Tư Duy Kì Thi Tốt Nghiệp THPT - Môn Sinh Học',
        'Nhiều Tác Giả',
        'Sách tham khảo',
        '',
        NULL,
        120000.00,
        './assets/img/sach-kham-khao/sinhhoc.png',
        500,
        150000.00,
        '-20%',
        NULL,
        ...
        '28 x 22 x 1.2',
        'Bìa mềm',
        '<p><b>Đột Phá Tư Duy Kì Thi Tốt Nghiệp THPT - Môn Sinh Học</p></b>\r\n<br><br>\r\nSÁCH ĐỘT PHÁ TƯ DUY KÌ THI TỐT NGHIỆP THPT MÔN TOÁN Theo cấu trúc định hướng thi mới năm 2025 của BGD\r\n<br><br>\r\nVới cấu trúc đề thi mới, các dạng câu hỏi mới và cả nội dung, cách thức hỏi mới theo định hướng đánh giá năng lực (tăng cường các câu hỏi, bài tập vận dụng thực tiễn để tránh học thuộc lòng, học vẹt, học tủ), kì thi 2025 sẽ có khả năng phân loại các mức điểm số rất cao.\r\n<br><br>\r\nNếu bạn đang gặp vấn đề và lo lắng trước kì thi thì cuốn sách Đột phá tư duy kì thi tốt nghiệp THPT môn Toán sẽ là một trợ thủ đắc lực giúp bạn giải quyết những vấn đề ấy.\r\n<br><br>\r\nĐược biên soạn bởi đội ngũ tác giả là những thủ khoa, các giáo viên chuyên, các chuyên viên nghiên cứu chương trình lâu năm tại WinEdu, sách mang đến cho bạn những giải pháp hiệu quả cho kì thi:\r\n<br><br>\r\nCấu trúc mới – tự tin trước sự thay đổi\r\n<br><br>\r\nCác chủ đề trong sách bám sát theo chương trình mới, định hướng thi mới với 3 hình thức câu trắc nghiệm mới:\r\n<br><br>\r\n+ Trắc nghiệm nhiều phương án lựa chọn\r\n<br><br>\r\n+ Trắc nghiệm đúng sai\r\n<br><br>\r\n+ Trắc nghiệm trả lời ngắn\r\n<br><br>\r\nCác bài tập trong sách cũng được cập nhật theo định hướng nội dung mới: tăng cường các bài tập thực tiễn, các dạng bài thi đánh giá năng lực. Bạn có thể sử dụng sách để ôn thi tốt nghiệp và các kì thi đánh giá năng lực của các trường.\r\n<br><br>\r\nInfographic - Biến mỗi trang sách thành một bức tranh sống động\r\n<br><br>\r\nToàn bộ lí thuyết trong sách được tổng hợp ngắn gọn lại bằng Infographic giúp bạn nâng cao cảm hứng học, dễ hiểu, kết nối kiến thức và ghi nhớ nhanh hơn.\r\n<br><br>\r\nPhân dạng và hướng dẫn chi tiết – Phát triển tư duy theo cách của riêng bạn\r\n<br><br>\r\nBài tập trong sách được tuyển tập các bài lạ và khó.\r\n<br><br>\r\nMỗi dạng bài có phương pháp làm cụ thể. Kèm theo đó là hệ thống các ví dụ mẫu, các sơ đồ phân tích tư duy giúp bạn nắm vững được cách làm và phát triển tư duy để vận dụng giải quyết được tất cả các bài tập khác.\r\n<br><br>\r\nLuyện đề theo lộ trình – Đừng luyện quá nhiều, hãy luyện thông minh\r\n<br><br>\r\nSách có một lộ trình luyện đề với 18 đề chia làm 3 giai đoạn giúp bạn luyện đề hiệu quả hơn:\r\n<br><br>\r\n- Giai đoạn 1: Khởi động: bắt đầu luyện từ những đề dễ để củng cố kiến thức;\r\n<br><br>\r\n- Giai đoạn 2: Tăng tốc: nâng cao mức độ khó của đề tương đương đề thi thật;\r\n<br><br>\r\n- Giai đoạn 3: Về đích: luyện đề khó hơn đề thi thật, bứt phá điểm 9-10.\r\n<br><br>\r\nGiải chi tiết bằng video – Tìm ra lỗ hổng kiến thức\r\n<br><br>\r\nCác đề trong sách được chữa chi tiết bằng video giúp bạn dễ dàng tiếp thu và được phân tích rõ những sai lầm mắc phải. Từ đó bạn sẽ xác định được những phần kiến thức cần được bồi đắp.\r\n<br><br>\r\nHọc liệu tặng kèm – Luôn đồng hành và dõi theo bạn\r\n<br><br>\r\nTặng thêm 10 đề thi thử mở rộng.\r\n<br><br>\r\nKhi mua sách, bạn sẽ được truy cập và sử dụng hệ thống học liệu đa dạng, chất lượng và liên tục được cập nhật, theo sát quá trình học của bạn. Bạn sẽ không cần mất công tìm kiếm thêm tài liệu học tập nữa.\r\n<br><br>\r\nVới thiết kế khoa học, cuốn sách sẽ giúp bạn ôn luyện thi hiệu quả, tiết kiệm thời gian và đạt được kết quả cao hơn mà chi phí chỉ bằng một buổi học thêm hay một cái áo.\r\n<br><br>\r\nChúc bạn học tập hiệu quả và bứt phá điểm số trong kì thi quan trọng phía trước!',
        0,
        '8936225421363',
        255
    ),
    (
        ...
        'Dung Vũ, Hà Thùy Linh, Cao Hằng',
        'Sách tham khảo',
        '',
        NULL,
        80000.00,
        './assets/img/sach-kham-khao/nguvan.png',
        600,
        10000.00,
        '-20%',
    ...
    (
        8,
        'Tổng ôn hoá học',
        'Phạm Hùng Vương, Trần Công Minh, Lê Quỳnh Trang',
        'Sách luyện thi',
        '',
        '',
        199000.00,
        './assets/img/sach-luyen-thi/hoahoc.png',
        583,
        250000.00,
        '-20%',
        'Công Ty Cổ Phần Công Nghệ Giáo Dục Trực Tuyến Aladanh',
        ...
        '27 x 19 x 1.7',
        'Bìa mềm',
        'Tổng Ôn Hóa Học - Tập 2 (Theo Chương Trình SGK Mới)\r\n<br><br>\r\nQuý đọc giả thân mến!\r\n<br><br>\r\nSách giáo khoa mới theo chương trình GDPT2018 ra mắt đã đặt ra nhiều vấn đề cho không chỉ với các em học sinh mà còn là với giáo viên, phụ huynh. Đặc biệt là môn Hóa học với hệ thống gọi tên mới (chuẩn Quốc tế); các kiến thức chuyên sâu và hoàn toàn khác mới so với chương trình GDPT2006 cũ. Đó là một hướng đi tích cực. Tuy nhiên, với khuôn khổ sách giáo khoa, cũng như những hạn chế đại trà, các kiến thức trong các tài liệu chuẩn (Kết Nối Tri Thức, Cánh Diều, Chân Trời Sáng Tạo,...) được chỉ ra ngắn gọn, theo hướng liệt kê, trình bày,... mà thiếu đi sự diễn giải, phân tích, đào sâu, phát triển, mở rộng hay liên hệ với nhau.\r\n<br><br>\r\nHóa học là môn khoa học thực nghiệm. Cần thực hành và nghiệm chứng kết quả. Tuy nhiên, với điều kiện ở cấp độ THPT và tài liệu hiện hành, các em dường như chấp nhận các kết quả mà sách giáo khoa đưa ra mà thiếu đi sự phản biện, tư duy và phân tích trả lời “tại sao vậy?”. Dần đây sẽ là một tư duy xấu và ảnh hưởng đến sự phát triển của chính các em sau này.\r\n<br><br>\r\nHiểu được các vấn đề đó, nhóm tác giả chúng tôi xin phép cho ra mắt bộ sách “TỔNG ÔN HÓA HỌC\" gồm có 2 tập - tập trung và ưu tiên kiến thức, xây dựng, phát triển và mở rộng NỀN TẢNG môn Hóa học. Để biên soạn cuốn sách, ngoài kiến thức bé nhỏ của nhóm, chúng tôi còn chọn lọc sử dụng, tham khảo, cũng như phản biện từ các tài liệu trong và ngoài nước, thậm chí là tiến hành các thực nghiệm, mô phỏng.\r\n<br><br>\r\nTổng ôn Hóa học – Tập 2 nối tiếp tập 1 gồm 4 chủ đề tiếp theo trong chương trình học, SGK hiện hành:\r\n<br><br>\r\n- Chủ đề 5. PIN ĐIỆN – ĐIỆN PHÂN\r\n<br><br>\r\n- Chủ đề 6. ĐẠI CƯƠNG VỀ KIM LOẠI\r\n<br><br>\r\n- Chủ đề 7. NGUYÊN TỐ NHÓM IA VÀ NHÓM IIA\r\n<br><br>\r\n- Chủ đề 8. SƠ LƯỢC VỀ KIM LOẠI CHUYỂN TIẾP DÂY THỨ NHẤT VÀ PHỨC CHẤT\r\n<br><br>\r\nMỗi chủ để được chia nhỏ thành các bài học cung cấp lý thuyết, phân tích diễn giải các vấn đề, sau đó là luyện tập thực hành.\r\n<br><br>\r\nCuốn sách cũng sẽ giúp các em học sinh trả lời câu hỏi làm thế nào để giải quyết vấn đề thi cử hiện nay với nhiều kỳ thi khác nhau (thi học kỳ, Tốt nghiệp, Đánh giá năng lực, Đánh giá tư duy, ...), nhiều form, nhiều dạng câu hỏi mới lạ,...\r\n<br><br>\r\nCâu trả lời chỉ có một, đó là kiến thức. Câu hỏi có như thế nào, nhiều form, nhiều dạng đến bao nhiêu đi chăng nữa thì cuối cùng nó cũng chỉ là để kiểm tra xem các em đọc hiểu bản chất của vấn đề đến mức độ nào mà thôi. Đứng trước kiến thức, các phương pháp, thủ thuật hay mẹo đơn giản chỉ là kinh nghiệm được đúc kết ra sau khi đã làm rất nhiều lần mà thôi.\r\n<br><br>\r\nCũng nói lại, nếu có kiến thức không thôi cũng là chưa đủ, để hoàn thành tốt các bài thi, các em cần rèn luyện, học cách sử dụng kiến thức để giải quyết vấn đề. “Trăm hay không bằng tay quen”, nếu các dạng câu hỏi mới lạ mà chúng ta cảm giác “quen” hay có vẻ như \"đã từng làm\" thì tâm lí hay sự tự tin sẽ giúp chúng ta vượt qua bài kiểm tra dễ dàng hơn. Bởi vậy, phần luyện tập của cuốn sách có đẩy đủ các dạng thức câu hỏi ôn luyện thi hiện nay:\r\n<br><br>\r\n> Dạng 1: TRẮC NGHIỆM KHÁCH QUAN: mỗi câu hỏi chỉ có một đáp án đúng.\r\n<br><br>\r\n> Dạng 2: TRẮC NGHIỆM ĐÚNG SAI – mỗi ý a), b), c), d) chọn đúng hoặc sai.\r\n<br><br>\r\n> Dạng 3: TRẮC NGHIỆM YÊU CẦU TRẢ LỜI NGẮN – Điền đáp án\r\n<br><br>\r\n> Dạng 4: BÀI TẬP ĐỌC HIỂU – đọc thông tin và trả lời các câu hỏi sau đó\r\n<br><br>\r\nCác đề luyện tập sẽ có gắn ID. [4150**]; các em làm theo hướng dẫn tra ID và gõ tra ID tương ứng sẽ xem được đáp án, lời giải chi tiết của các bài tập trong đó. Thêm nữa, hỗ trợ mỗi đơn vị bài học, phần online sẽ có tặng kèm các đơn vị bài giảng tương ứng cũng được gắn ID - [4150**], một số buổi live chữa và giải đáp thắc mắc của các em. Hãy tra ID cuốn sách: 415000 để có thể nhìn rõ được bố cục bài giảng và đề thi và các tiện tích phần online nhé.!\r\n<br><br>\r\nMột người thầy có giỏi đến mấy cũng không thể giúp các em học tốt nếu bản thân các em không có tỉnh thần vượt khó – tự học. Với môn hóa học, các em cần chọn một phương pháp học thông minh và sử dụng thật tối ưu cuốn sách ID: học trên lớp, sau đó tổng ôn lại theo phần lý thuyết trọng tâm, kết hợp xem video bài giảng online hỗ trợ, ghi chép lại những phần cần thiết cho bản thân; sau đó tự nghiền ngẫm các ví dụ minh họa, so sánh với lời giải, chia sẻ mà cuốn sách cung cấp để dần hình thành tư duy, phương pháp giải các dạng bài. Cuối cùng thực hành giải các bài tập vận dụng với đáp án và lời giải chỉ thiết sẵn có trên moon.vn. Tuy nhiên, các em hãy tự nghiêm túc làm trước khi tra cứu. Đừng quên, nếu gặp khó khăn gì thì phần bình luận ở mỗi ID bài tập sẽ giúp các em trao đổi và giải quyết. Thêm nữa, có lẽ nhóm tác giả cũng đã nhắc đi khá nhiều lần, đó là ghi chép. Kết thúc mỗi bài học, đừng vội vàng đóng sách lại, hãy dành chút thời gian “NGẪM\" những gì đã học được, ghi chép lại những điều hay ho còn nóng hổi vừa thu được.\r\n<br><br>\r\nTác giả chắc chắn rằng, khi các em lĩnh hội hết cuốn sách này thì những câu hỏi vô cơ trong các đề thi sẽ không còn làm khó được các em nữa. Cuốn sách cũng hi vọng sẽ là nguồn tư liệu cung cấp câu hỏi chất lượng, đầy đủ và có hệ thống cho các thầy cô giáo tham khảo.\r\n<br><br>\r\nMột cuốn sách không thể hoàn hảo nếu không nhận được các phản hồi quý báu. Mặc dù đã rất trau chuốt, tỉ mỉ nhưng cuốn sách vẫn không thể tránh khỏi thiếu sót. Tác giả rất mong nhận được sự đồng cảm và những góp ý chân tình của độc giả để cuốn sách thêm hoàn thiện trong những lần in sau.\r\n<br><br>\r\nXin chân thành cảm ơn',
        43,
        '9786044028705',
        200
    ),
    (
        ...
        'Bán chạy',
        62000.00,
        './assets/img/sach-thieu-nhi/dat-rung-phuong-nam.png',
        45,
        81000.00,
        '23%',
        'NXB Kim Đồng',
    ...
    (
        ...
        NULL,
        74000.00,
        './assets/img/sach-thieu-nhi/100-ki-nang.png',
        55,
        100000.00,
        '-25%',
        'Đình Tị',
    ...
    (
        ...
        'Bán chạy',
        44000.00,
        './assets/img/sach-thieu-nhi/de-men.png',
        543,
        50000.00,
        '13%',
        'Nhà xuất bản Kim Đồng',
    ...
    (
        12,
        'Tiểu Sử Các Quốc Gia Qua Góc Nhìn Lầy Lội',
        'Sai Lei',
        'thiếu nhi',
        '',
        'Bán chạy',
        176000.00,
        './assets/img/sach-thieu-nhi/tieu-su-cac-nuoc.png',
        1000,
        215000.00,
        '18%',
        'Nhã Lam',
        ...
        '20.5 x 17',
        'Bìa mềm',
        'Iceland dân số ít ỏi mà dám đọ sức với Anh? Na Uy in hình con cá ướp muối lên tờ tiền? Anh có thật là đế quốc mặt trời không bao giờ lặn? Đan Mạch là vương quốc mộng ảo còn Hà Lan là đất nước của tự do thực sự? Bỉ từng được giải cứu nhờ bãi nước tiểu của một cậu bé? Thụy Sĩ siêu giàu có nhờ trung lập, Ý chỉ quan tâm tận hưởng cuộc sống? Ai Cập thích xây kim tự tháp, Nam Phi nằm ở châu Phi nhưng lại từng kỳ thị người da đen, Argentina mê bóng đá hơn kiếm tiền…?\r\n<br><br>\r\nNhân cách hóa, bỏ qua những chi tiết rườm rà, sử dụng ngôn ngữ hài hước dí dỏm cô đọng lại con đường phát triển của các quốc gia, Sai Lei qua góc nhìn có phần “lầy lội” của mình sẽ đem đến cho bạn đọc cách tiếp cận lịch sử thế giới hết sức mới mẻ, gần gũi và dễ hiểu.\r\n<br><br>\r\n<p><b>TÁC GIẢ:</p></b>\r\n<br><br>\r\n<p><b>Sai Lei</p></b>\r\nTác giả chuyên mục lịch sử “Sai Lei ba phút” trên Zhihu với hơn một trăm nghìn lượt theo dõi.\r\nTác phẩm tiêu biểu: Sai Lei ba phút - Truyện tranh sử Trung Quốc, Sai Lei ba phút - Truyện tranh lược sử nhân loại…',
        5,
        '8935235229747',
        100
    ),
    (
        ...
        NULL,
        71000.00,
        './assets/img/sach-thieu-nhi/hang-tu-be.png',
        80,
        89000.00,
        '-20%',
        'AZ Việt Nam',
    ...
    (
        14,
        'Lược Sử Nước Việt Bằng Tranh (Tái Bản 2024)',
        'Tạ Huy Long, Dương Trung Quốc, Hiếu Minh, Huyền Trang',
        'thiếu nhi',
        '',
        'Xu hướng',
        121000.00,
        './assets/img/sach-thieu-nhi/luoc-su-nuoc-viet.png',
        55,
        14000.00,
        '13%',
        'Kim Đồng',
    ...
    (
        ...
        'Bán chạy',
        62000.00,
        './assets/img/sach-thieu-nhi/tuoi-tho-du-doi.png',
        15,
        80000.00,
        '23%',
        'Nhà Xuất Bản Kim Đồng',
    ...
    (
        ...
        '',
        176000.00,
        './assets/img/sach-van-hoc/thitranvagiacmo.png',
        10,
        210000.00,
        '16%',
        'NXB Trẻ',
    ...
    (
        17,
        'Ngồi Khóc Trên Cây (Tái Bản 2022)',
        'Nguyễn Nhật Ánh',
        'Văn học',
        'Tiểu thuyết',
        NULL,
        109000.00,
        './assets/img/sach-van-hoc/ngoitrencaykhoc.png',
        25,
        130000.00,
        '16%',
        'NXB Trẻ',
    ...
    (
        18,
        'Có Một Ngày, Bố Mẹ Sẽ Già Đi (Tái Bản 2024)',
        'Nhiều Tác Giả',
        'Văn học',
        'Tiểu thuyết',
        NULL,
        71000.00,
        './assets/img/sach-van-hoc/parent.png',
        10,
        92000.00,
        '23%',
        'AZ Việt Nam',
    ...
    (
        ...
        'Xu hướng',
        1.00,
        './assets/img/sach-van-hoc/hodiepvakinhngu.png',
        50,
        155000.00,
        '30%',
        'Đinh Tị',
    ...
    (
        ...
        'Bán chạy',
        179000.00,
        './assets/img/sach-van-hoc/sontra.png',
        37,
        248000.00,
        '28%',
        'Đinh Tị',
    ...
    (
        21,
        ' 999 Lá Thư Gửi Cho Chính Mình - Những Lá Thư Ấn Tượng Nhất - Phiên Bản Song Ngữ Trung-Việt (Tái Bản 2024)',
        'Miêu Công Tử',
        'Văn học',
        '',
        'Bộ',
        97000.00,
        './assets/img/icon/vanhoc/999lathu.png',
        10,
        119000.00,
        '18%',
        'AZ Việt Nam',
...
VALUES (
        ...
        'Xu hướng',
        76000.00,
        './assets/img/icon/vanhoc/tron.png',
        5,
        95000.00,
        '20%',
        'Skybooks',
    ...
    (
        ...
        NULL,
        60000.00,
        './assets/img/icon/vanhoc/thuong.png',
        20,
        75000.00,
        '20%',
        'Skybooks',
    ...
    (
        ...
        'Xu hướng',
        89000.00,
        './assets/img/icon/vanhoc/caycam.png',
        76,
        108000.00,
        '18%',
        'Nhã Nam',
        ...
        '20 x 14.5 cm',
        'Bìa Mềm',
        'CÂY CAM NGỌT CỦA TÔI - MỘT TUỔI THƠ BỊ LÃNG QUÊN \r\nVới một đứa trẻ, thế giới không giới hạn trong một bữa ăn, mà thế giới cần có hào quang của tình thương. Bạn có bao giờ cảm thấy bị lạc lõng trong chính ngôi nhà của mình? Một câu chuyện chạm đến tận cùng cảm xúc\r\n<br><br>\r\nVỀ TÁC GIẢ: José Mauro de Vasconcelos \r\nÔng là một nhà văn vĩ đại nhưng lại có xuất thân nghèo khó ở Brazil. Ông từng làm nhiều công việc khác nhau trước khi trở thành nhà văn\r\n<br><br>\r\nNhững trải nghiệm tuổi thơ đầy gian truân là nguồn cảm hứng để ông viết nên Cây Cam Ngọt Của Tôi (1968) – tác phẩm nổi tiếng nhất trong sự nghiệp.\r\n<br><br>\r\nVăn phong giản dị, chân thực, giàu cảm xúc, khiến bao thế hệ độc giả rơi nước mắt và suy ngẫm về tình yêu thương, sự mất mát và giá trị của một tuổi thơ trọn vẹn.\r\n<br><br>\r\nVỀ DỊCH GIẢ: Nguyễn Lê Minh \r\nLà một dịch giả giàu kinh nghiệm trong việc chuyển ngữ các tác phẩm văn học nước ngoài, đặc biệt là các tác phẩm văn học Latin.\r\n<br><br>\r\nBản dịch “Cây Cam Ngọt Của Tôi” của ông được đánh giá cao vì giữ trọn vẹn tinh thần, cảm xúc và sự trong trẻo của nguyên tác, giúp người đọc Việt Nam đắm chìm trong từng câu chữ và cảm nhận được sự trong sáng, mơ mộng nhưng cũng đầy đau thương của cậu bé Zezé.\r\n<br><br>\r\nTÓM TẮT NỘI DUNG SÁCH\r\nNếu tuổi thơ là một món quà, thì với Zezé, đó là một món quà có cả vị ngọt lẫn đắng.\r\n<br><br>\r\nZezé - một cậu bé nghèo năm tuổi tại Brazil, thông minh, lém lỉnh nhưng luôn bị gia đình xem như một đứa trẻ hư. Những trò nghịch ngợm của cậu thường bị trừng phạt bằng đòn roi, nhưng ai biết rằng đằng sau đó là một trái tim khao khát yêu thương?\r\n<br><br>\r\nNgười bạn duy nhất luôn lắng nghe cậu chính là cây cam ngọt nhỏ bé trong vườn, nơi cậu có thể gửi gắm những bí mật và nỗi buồn của mình. Rồi một ngày, Zezé gặp ông Portuga - một người đàn ông xa lạ nhưng lại là ánh sáng dịu dàng đầu tiên trong cuộc đời đầy bão tố của cậu bé. Ông dạy cậu về lòng nhân ái, về tình yêu thương vô điều kiện - thứ mà Zezé luôn khao khát nhưng chưa từng có được.\r\n<br><br>\r\nNhưng rồi, số phận không cho phép Zezé giữ mãi những hạnh phúc nhỏ nhoi đó…\r\n<br><br>\r\nCây Cam Ngọt Của Tôi không chỉ là câu chuyện của một cậu bé – đó còn là bức tranh về những nỗi đau vô hình của tuổi thơ, về sự khắc nghiệt của cuộc sống nhưng cũng đầy những tia sáng hy vọng.\r\n<br><br>\r\nQuyển sách mang đến cho bạn:\r\n<br><br>\r\nSự đồng cảm sâu sắc với những đứa trẻ nhạy cảm nhưng không được thấu hiểu.\r\n<br><br>\r\nNhững khoảnh khắc ngọt ngào đan xen cùng nỗi đau mất mát, để lại dư âm khó quên.\r\n<br><br>\r\nBài học quý giá về tình yêu thương, lòng trắc ẩn và sự quan tâm đến những người xung quanh.\r\n<br><br>\r\nNhận ra vẻ đẹp thực sự của cuộc sống đến từ những điều giản dị, và rằng cuộc đời thật khốn khổ nếu thiếu đi lòng yêu thương và niềm trắc ẩn.\r\n<br><br>\r\nTại sao bạn nên đọc? \r\n<br><br>\r\nMột trong những tác phẩm văn học châu Mỹ Latin hay và bán chạy nhất Brazil và thế giới.\r\n<br><br>\r\nMột câu chuyện khiến bất kỳ ai cũng phải suy ngẫm, dù bạn là trẻ con hay đã trưởng thành.\r\n<br><br>\r\nMột cuốn sách giúp bạn trân trọng hơn những điều giản dị và nhìn lại tuổi thơ của chính mình.',
        2,
        '8935235228351',
        220
    ),
    (
        ...
        NULL,
        121000.00,
        './assets/img/icon/vanhoc/tet.png',
        56,
        169000.00,
        '28%',
        'Đinh Tị',
    ...
    (
        26,
        'Bộ Sách Kể Chuyện Cuộc Đời Các Thiên Tài (Bộ 12 Cuốn)',
        'Rasmus Hoài Nam',
        'thiếu nhi',
        'combo thiếu nhi',
        NULL,
        546750.00,
        './assets/img/combo/cuoc-doi-thien-tai.png',
        79,
        729000.00,
        '-25%',
        'Thanh Việt',
        ...
        '20.5 x 14.5 x 10',
        'Bìa Mềm',
        'Elbert Einstein, Thomas Edison, Andersen, Leonardo Da Vinci, Marie Curie, Lev Tolstoy, Isaac Newton, Alfred Nobel,... vẫn được mệnh danh là những danh nhân vĩ đại nhất của thế giới. Sự tài năng, thông minh, tính kiên trì của họ khiến tất cả thế giới phải nể phục và ngưỡng mộ. \r\n<br><br>\r\nVậy, cuộc đời thực sự của họ ra sao? Bình dị hay có những câu chuyện bí ẩn chưa được biết đến? Đằng sau ánh hào quang của danh vọng và thành công thì ai là người có ảnh hưởng sâu sắc đến nhân cách và sự nghiệp của họ? Tất cả điều đó sẽ được chia sẻ trong qua bộ sách \"Chuyện kể về cuộc đời những thiên tài\".\r\n<br><br>\r\nBộ Sách bao gồm:\r\n<br><br>\r\nAlexander Popov\r\n<br><br>\r\nAnton Chekhov\r\n<br><br>\r\nElbert Einstein\r\n<br><br>\r\nThomas Edison\r\n<br><br>\r\nAndersen\r\n<br><br>\r\nLeonardo Da Vinci\r\n<br><br>\r\nMarie Curie\r\n<br><br>\r\nLev Tolstoy\r\n<br><br>\r\nIsaac Newton\r\n<br><br>\r\nAlfred Nobe\r\n<br><br>\r\nBeethoven\r\n<br><br>\r\nVictor Hugo',
        5,
        '8935210305497',
        200
    ),
    (
        27,
        'Bộ Sách Truyện Tranh Song Ngữ Việt-Anh Cho Bé (Bộ 10 Cuốn)',
        'Khánh Vân, Quỳnh Rùa',
        'thiếu nhi',
        'combo thiếu nhi',
        NULL,
        123000.00,
        './assets/img/combo/truyen-tranh-song-ngu.png',
        193,
        150000.00,
        '-18%',
        'Đinh Tị',
    ...
    (
        28,
        'Combo Sách Kỹ Năng Sống Đầu Đời Cho Bé (Bộ 5 Cuốn)',
        'Thẩm Viên, Khương Tĩnh Á',
        'thiếu nhi',
        'combo thiếu nhi',
        NULL,
        97000.00,
        './assets/img/combo/kns-dau-doi.png',
        27,
        150000.00,
        '13%',
        'Nhà Xuất Bản Kim Đồng',
        ...
        '17.5 x 17.5 x 2',
        'Bìa Mềm',
        '<p><b>Combo Kĩ Năng Giao Tiếp - Dành Cho Bé 2 - 6 Tuổi (Bộ 10 Cuốn ) (Tái Bản 2022)</p></b>\r\n\r\nKhả năng giao tiếp hạn chế sẽ tạo nên những tổn thất rất lớn về tâm sinh lí của mỗi người nói chung và mỗi đứa trẻ nói riêng. Vì vậy, ngay từ khi em bé được sinh ra, phụ huynh nên chú trọng việc giao tiếp với bé và hình thành kĩ năng giao tiếp cho bé.\r\n<br><br>\r\nBộ sách PHÁT TRIỂN KĨ NĂNG GIAO TIẾP sẽ giúp các bé 2- 6 tuổi nhanh chóng có kĩ năng giao tiếp tốt. Những câu chuyện trong sách khiến bé hiểu khi nào cần nói lời chào, lời mời, lời cảm ơn, lời xin lỗi v.v… Những câu nói hay và những cử chỉ đẹp sẽ khiến bé trở thành một người lịch sự, thân thiện và vô cùng đáng mến!\r\n<br><br>\r\nMỗi cuốn gồm từ 2-3 câu chuyện nhỏ kèm tranh vẽ ngộ nghĩnh đáng yêu chắc chắn sẽ làm bé thích thú và học được nhiều điều: - Bé sẽ biết nói lời cảm ơn khi người khác giúp đỡ, quan tâm, tặng quà... cho mình. - Bé biết xin lỗi khi mình làm sai, làm người khác phải buồn lòng... - Bé biết dùng lời mời trước bữa ăn, mời khách vào nhà, mời khách uống nước... - Bé biết chào hỏi người lớn và bạn bè khi gặp mặt... - Bé biết nói lời tạm biệt khi chia tay... - Bé biết động viên, an ủi khi người thân hoặc bạn bè mình buồn. - Bé biết cất lời khen và vui sướng khi nhận lời khen. - Bé biết nói lời từ chối với những việc mình không thích hoặc những việc sai trái. - Bé biết hứa và giữ lời hứa. - Bé biết nói lời chúc, chúc mừng với mọi người nhân những sự kiện cụ thể như sinh nhật, Tết...',
        0,
        '8935244862553',
        100
    ),
    (
        29,
        'Combo Sách Xôn Xao Đầu Đời (Bộ 4 Cuốn)',
        'Pauline Oud',
        'thiếu nhi',
        'combo thiếu nhi',
        NULL,
        200000.00,
        './assets/img/combo/xon-xao-dau-doi.png',
        7,
        240000.00,
        '-15%',
        'Nhà Xuất Bản Kim Đồng',
        ...
        '26 x 25 x 0.9',
        'Bìa Mềm',
        '<p><b>Combo Sách Xôn Xao Đầu Đời (Bộ 4 Cuốn)</p></b>\r\n\r\n<p><b>1. Xôn Xao Đầu Đời: Em Bé Từ Đâu Đến</p></b>\r\n\r\nNoah sắp trở thành chị. Trong bụng mẹ đang có một em bé. Nhưng làm sao em bé chui vào bụng mẹ được nhỉ? Em bé lớn lên ra sao? Bao giờ em sẽ ra khỏi bụng mẹ và bằng cách nào? Tất cả những câu hỏi này sẽ được trả lời bằng những mẩu chuyện ngắn gần gũi cùng những kiến thức thực tế thú vị.\r\n<br><br>\r\n“Với bộ sách bốn tập Xôn Xao Đầu Đời, Pauline Oud giới thiệu với trẻ ở độ tuổi thiếu nhi về cơ thể của chính các em, sự sinh sản, sức mạnh tinh thần và lòng tự tin, gia đình và các mối quan hệ, cũng như các cảm xúc theo một cách sáng rõ và giàu tính tương tác. Mỗi tập xoay quanh một chủ đề chính và cả bộ sách tạo thành nền tảng cho sự phát triển tính dục lành mạnh. Mà không chỉ nói “qua qua”, bộ sách nói cho “ra vấn đề” đấy nhé!” - PGS TS Trần Thành Nam - Chuyên gia Tâm lý, GK Khoa học Siêu Trí tuệ Việt Nam\r\n<br><br>\r\n<p><b>2. Xôn Xao Đầu Đời: Gia Đình Bạn - Gia Đình Tớ</p></b>\r\n<br><br>\r\nBố, mẹ, anh chị em là gia đình của bé. Ông bà nội, ông bà ngoại, các cô, dì, chú, bác, thím, cậu, mợ: họ cũng đều là người thân của bé và cùng quan tâm, chăm sóc bé. Có bé sống lúc với bố, lúc với mẹ. Có bé có tận hai bà mẹ, có bé thì chỉ có bố, có bé lại được bà nuôi nấng. Không gia đình nào giống gia đình nào!\r\n<br><br>\r\n“Với bộ sách bốn tập Xôn Xao Đầu Đời, Pauline Oud giới thiệu với trẻ ở độ tuổi thiếu nhi về cơ thể của chính các em, sự sinh sản, sức mạnh tinh thần và lòng tự tin, gia đình và các mối quan hệ, cũng như các cảm xúc theo một cách sáng rõ và giàu tính tương tác. Mỗi tập xoay quanh một chủ đề chính và cả bộ sách tạo thành nền tảng cho sự phát triển tính dục lành mạnh. Mà không chỉ nói “qua qua”, bộ sách nói cho “ra vấn đề” đấy nhé!” - PGS TS Trần Thành Nam - Chuyên gia Tâm lý, GK Khoa học Siêu Trí tuệ Việt Nam\r\n<br><br>\r\n<p><b>3. Xôn Xao Đầu Đời: Khi Nào Nên Nói \"\"Có\"\", Khi Nào Nên Nói \"\"Không\"\"</p></b>\r\n\r\nKhi nào bé nên nói “có” và khi nào bé nên nói “không”?\r\n<br><br>\r\nKhi nào bé có thể làm một việc và khi nào bé không thể?\r\n<br><br>\r\nLiệu bé có thể lắng nghe khi ai đó nói “không” với mình?\r\n<br><br>\r\nNhững bí mật nho nhỏ nào hay ho, những bí mật nào không?\r\n<br><br>\r\nCuốn sách này sẽ dạy bé một điều: Bé chính là chủ của cơ thể mình.\r\n<br><br>\r\n“Với bộ sách bốn tập Xôn Xao Đầu Đời, Pauline Oud giới thiệu với trẻ ở độ tuổi thiếu nhi về cơ thể của chính các em, sự sinh sản, sức mạnh tinh thần và lòng tự tin, gia đình và các mối quan hệ, cũng như các cảm xúc theo một cách sáng rõ và giàu tính tương tác. Mỗi tập xoay quanh một chủ đề chính và cả bộ sách tạo thành nền tảng cho sự phát triển tính dục lành mạnh. Mà không chỉ nói “qua qua”, bộ sách nói cho “ra vấn đề” đấy nhé!” - PGS TS Trần Thành Nam - Chuyên gia Tâm lý, GK Khoa học Siêu Trí tuệ Việt Nam\r\n<br><br>\r\n<p><b>4. Xôn Xao Đầu Đời: Tất Tần Tật Về Cơ Thể Bé</p></b>\r\n\r\nCuốn sách này cho bé biết về cơ thể của chính mình, từ đỉnh đầu đến ngón chân. Bé có biết tên mỗi bộ phận không?\r\n<br><br>\r\nBé có biết phải chăm sóc cơ thể mình như thế nào, hoặc phải làm gì khi bị ốm không? Cuốn sách này sẽ bật mí cho bé tất cả!\r\n<br><br>\r\n“Với bộ sách bốn tập Xôn Xao Đầu Đời, Pauline Oud giới thiệu với trẻ ở độ tuổi thiếu nhi về cơ thể của chính các em, sự sinh sản, sức mạnh tinh thần và lòng tự tin, gia đình và các mối quan hệ, cũng như các cảm xúc theo một cách sáng rõ và giàu tính tương tác. Mỗi tập xoay quanh một chủ đề chính và cả bộ sách tạo thành nền tảng cho sự phát triển tính dục lành mạnh. Mà không chỉ nói “qua qua”, bộ sách nói cho “ra vấn đề” đấy nhé!” - PGS TS Trần Thành Nam - Chuyên gia Tâm lý, GK Khoa học Siêu Trí tuệ Việt Nam',
        0,
        'combo-0406202404',
        55
    ),
    (
        30,
        'Truyện Cổ Tích Việt Nam - Cây Khế (Song ngữ Việt - Anh)',
        'Thùy Dương',
        'thiếu nhi',
        'cổ tích',
        NULL,
        13000.00,
        './assets/img/sach-thieu-nhi/cay-khe.png',
        101,
        16000.00,
        '-18%',
        'Đình Tị',
        ...
        '20.5 x 20.5',
        'Bìa mềm',
        'Truyện cổ tích từ bao đời nay luôn có sức hấp dẫn không thể phủ nhận đối với trẻ em. Thế nhưng, trước sự ảnh hưởng của internet, truyện cổ tích ngày nay không thể chỉ là những cuốn sách giấy trắng mực đen, mà buộc phải trở nên ấn tượng hơn, thu hút hơn. Đó cũng là lý do bộ \"Truyện cổ tích Việt Nam\" của Đinh Tị Books ra đời. \r\n<br><br>\r\n5 câu chuyện quen thuộc được lưu truyền từ thế hệ này sang thế hệ khác như Tấm Cám - Thánh Gióng - Sơn tinh Thủy Tinh - Cóc kiện trời - Cây khế, dưới bàn tay tài hoa của các họa sĩ, thiết kế đã hiện lên vô cùng sống động, rực rỡ. Nội dung mỗi câu truyện đều được vẽ minh họa lại toàn bộ, vừa mang nét hiện đại, lại vừa thể hiện được cái hồn riêng của truyện cổ tích truyện cổ tích Việt Nam.\r\n<br><br>\r\nKhông chỉ mở ra một thế giới huyền diệu, kỳ ảo với ông bụt bà tiên, Truyện cổ tích Việt Nam còn mang đến cho bé những bài học quý giá về những giá trị tốt đẹp của dân tộc, của cha ông truyền lại, được gửi gắm qua nội dung câu chuyện và những lời nhắn nhủ đầy yêu thương ở cuối mỗi cuốn sách, từ đó nuôi dưỡng tâm hồn trẻ thơ, để các bé phát triển tư duy đúng đắn, lành mạnh và trong sáng nhất. \r\n<br><br>\r\nĐặc biệt, sách được biên soạn dưới dạng song ngữ Việt - Anh, vừa giúp bé phát triển tiếng Việt, vừa giúp bé làm quen với tiếng Anh từ sớm, tạo tiền đề cho sự phát triển ngôn ngữ của trẻ về sau.\r\n<br><br>\r\nCuối mỗi trang sách đều có một trò chơi thú vị nho nhỏ, vừa giúp bé có những giờ phút thư giãn, vừa giúp rèn luyện trí nhớ và sự tập trung, ghi nhớ câu chuyện một cách tự nhiên.  ',
        0,
        '8935212358736',
        100
    ),
    (
        31,
        'Truyện Cổ Tích Thế Giới Hay Nhất - Cô Bé Bán Diêm',
        'Nhiều Tác Giả',
        'thiếu nhi',
        'cổ tích',
        NULL,
        13000.00,
        './assets/img/sach-thieu-nhi/co-be-ban-diem.png',
        101,
        16000.00,
        '-18%',
        'Đình Tị',
    ...
    (
        ...
        '13x20cm',
        'Bìa mềm',
        'Cuốn tiểu thuyết nổi tiếng về cậu bé Rémi',
        5,
        'VH003',
        100
    ),
    ...
    (
        ...
        '13x19cm',
        'Bìa mềm',
        'Những câu chuyện đầy nhân văn và cảm động',
        5,
        'TAMLY004',
        120
    ),
    (
        ...
        '16x24cm',
        'Bìa cứng',
        'Lịch sử tiến hóa và tư duy nhân loại',
        5,
        'KT003',
        70
    ),
    (
        ...
        '13x20cm',
        'Bìa mềm',
        'Tự truyện đầy xúc động và nhân văn',
        5,
        'TN004',
        200
    ),
    (
        ...
        '14x20cm',
        'Bìa mềm',
        'Bản cáo trạng mạnh mẽ về bất công',
        5,
        'TT003',
        90
    ),
    (
        ...
        '14x20cm',
        'Bìa mềm',
        'Giải mã cách hành vi hình thành',
        5,
        'TAMLY005',
        85
    ),
    (
        ...
        '13x20cm',
        'Bìa mềm',
        'Bi kịch của giấc mơ Mỹ thời kỳ Jazz Age',
        4,
        'TT004',
        60
    ),
    (
        ...
        '14x20cm',
        'Bìa mềm',
        'Giáo trình giao tiếp tiếng Anh dễ hiểu',
        4,
        'NN003',
        90
    ),
    (
        ...
        '16x24cm',
        'Bìa cứng',
        'Truyện trinh thám nổi tiếng thế giới',
        5,
        'TT005',
        100
    ),
    ...
    (
        ...
        '13x20cm',
        'Bìa mềm',
        'Cuốn sách truyền cảm hứng sống tích cực',
        4,
        'TAMLY007',
        60
    ),
    ...
    (
        ...
        '14x20cm',
        'Bìa mềm',
        'Kiệt tác văn học dân tộc Việt Nam',
        5,
        'VH004',
        140
    ),
